(function () {
  ...
  const portraits = [
    ...
    {name: 'female6.jpg', focus: {cx: 500/1024, cy: 620/1024, rx: 486/2048, ry: 545/2048}, text:'Female portrait 6 text'}, // ADJUST CENTER
    {name: 'female7.jpg', focus: {cx: 500/1024, cy: 620/1024, rx: 486/2048, ry: 545/2048}, text:'Female portrait 7 text'}, // ADJUST CENTER
  ];
  ...
  let startPlaying = () => {
    ...
    app2 = new PIXI.Application({ background: '#fff', antialias: false, width: size, height: size, autoStart: false,
				  clearBeforeRender: false, backgroundAlpha: 0, preserveDrawingBuffer: true});
    let canvas = app.view;
    makePage(canvas);
